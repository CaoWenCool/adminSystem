...
import com.demo.adminsystem.core.exception.PlatformEncryptRuntimeException;
...
public class PwdUtil {
    ...
    public static String md5(String str) {
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("MD5加密失败",e);
        }
    }
    ...
    private static String shaHex(String str,String type) {
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("SHA-"+type+"加密失败",e);
        }
        return str;
    }
    ...
    public static String strToBase64(String str) {
        ...
        try {
            ...
            throw new PlatformEncryptRuntimeException("BASE64编码失败",e);
        }
    }
    ...
    public static String base64ToStr(String b64Str) {
        try {
            ...
            throw new PlatformEncryptRuntimeException("BASE64解码失败",e);
        }
    }
    ...
    public static String encodeHexTest(String str){
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("HEX编码失败",e);
        }
    }
    /**
     * Hex解码(16进制)
    ...
    public static String decodeHexTest(String str){
        ...
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("HEX解码失败",e);
        }
    }
    ...
    private static byte[] pbkdf2(char[] password, byte[] salt, int bytes){
        ...
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("密码校验失败",e);
        }
    }
    ...
    public static String aesEncrypt(String content,String aesKey) {
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("AES加密失败",e);
        }
    }
    ...
    public static String aesDecrypt(String content,String aesKey) {
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("AES解密失败",e);
        }
    }
    ...
    public static String desEncrypt(String data, String key) {
        try {
            ...
            e.printStackTrace();
            throw new PlatformEncryptRuntimeException("DES加密失败",e);
        }
